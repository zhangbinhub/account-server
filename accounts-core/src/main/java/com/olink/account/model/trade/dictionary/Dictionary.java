...
public class Dictionary extends DBTable {
     ...
     * @return 上级字典对象
     */
    public Dictionary getParentObj(ConnectionFactory connectionFactory) {
        try {
            return (Dictionary) Dictionary.getInstance(getParentid(), this.getClass(), this, connectionFactory);
        } catch (Exception e) {

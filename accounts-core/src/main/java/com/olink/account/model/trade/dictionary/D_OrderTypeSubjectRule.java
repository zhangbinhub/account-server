 ...
 * 会计科目分录规则
 */
@ADBTable(tablename = "acc_dic_ordertype_subjectrule")
public class D_OrderTypeSubjectRule extends DBTable {
    ...
    public String getAccountsubitemid() {
        return accountsubitemid;
    }

    public void setAccountsubitemid(String accountsubitemid) {
        this.accountsubitemid = accountsubitemid;
    }
    ...
    @ADBTableField(name = "accountsubitemid", fieldType = DBTableFieldType.String, allowNull = false)
    private String accountsubitemid;//科目下立账户id

    @ADBTableField(name = "paytypecode", fieldType = DBTableFieldType.String)
    private String paytypecode;//交易类型编码

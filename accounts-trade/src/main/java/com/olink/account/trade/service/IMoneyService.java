 ...
 * C户信息服务接口
 */
public interface IMoneyService extends IBaseTradeService {
     ...
     */
    double[] doRecharge(BalanceRechargeOrder balanceRechargeOrder) throws ServerException;
     ...
     * @return true|false
     */
    boolean doCancleBalanceCash(String orderNo, String content, String userid) throws ServerException;
     ...
     * @return true|false
     */
    boolean doCancleBalanceSettlement(String orderNo, String content, String userid) throws ServerException;
